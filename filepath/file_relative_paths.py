...
class ImagePathAndProps(Enum):
    ...
    SCOUT_RETURN6_ICON_IMAGE_PATH = ['resource\\scout_returning6_icon.png', 
                            (1280, 720), (0, 0, 0, 0), 0.98, 25, RETURN_ICON6]
    SCOUT_RETURN7_ICON_IMAGE_PATH = ['resource\\scout_returning7_icon.png', 
    ...
    HOLD_ICON7_IMAGE_PATH = ['resource\\hold_icon7.png',
                            (1280, 720), (0, 0, 0, 0), 0.98, 25, HOLD_ICON7]
    PASS_ICON_IMAGE_PATH = ['resource\\pass_icon.png',
                            (1280, 720), (0, 0, 0, 0), 0.98, 25, PASS_ICON]
    PASS_ICON2_IMAGE_PATH = ['resource\\pass_icon2.png',
                            (1280, 720), (0, 0, 0, 0), 0.98, 25, PASS_ICON2]
